# Калибровка научных утверждений после рецензии
...
- заранее заявленные сравнения DoRA в рамках бюджета параметров LoRA получают отдельную поправку Холма для вторичной семьи сравнений (`m=3`); результат для смешанного сдвига составляет `+0.82 п.п.`, ДИ `[−0.22, +1.86]`, исходное `p=0.115696`, скорректированное `p=0.347089` и остаётся описательным;
