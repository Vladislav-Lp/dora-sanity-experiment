    ...
    manifest = {
        ...
        "blocks": [
            ...
            },
            {
                ...
                "type": "markdown",
                "body": (
                    "## Представительная способность ясна; при экстремальном изменении величины оптимизация несовершенна\n\n"
            ...
            },
            {
                ...
                "body": (
                    ...
                    "- Чем обусловлено преимущество в реальных сетях: представительной способностью, регуляризацией или обусловленностью оптимизации?\n"
